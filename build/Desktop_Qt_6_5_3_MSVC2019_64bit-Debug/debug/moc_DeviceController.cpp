...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDeviceControllerENDCLASS_t qt_meta_stringdata_CLASSDeviceControllerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(17, 17),  // "lightStateChanged"
        QT_MOC_LITERAL(35, 0),  // ""
        QT_MOC_LITERAL(36, 10),  // "LightState"
        QT_MOC_LITERAL(47, 5),  // "state"
        QT_MOC_LITERAL(53, 19),  // "curtainStateChanged"
        QT_MOC_LITERAL(73, 12)   // "CurtainState"
    },
    "DeviceController",
    "lightStateChanged",
    "",
...
void DeviceController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->lightStateChanged((*reinterpret_cast< std::add_pointer_t<LightState>>(_a[1]))); break;
        case 1: _t->curtainStateChanged((*reinterpret_cast< std::add_pointer_t<CurtainState>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (DeviceController::*)(LightState );
            if (_t _q_method = &DeviceController::lightStateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (DeviceController::*)(CurtainState );
            if (_t _q_method = &DeviceController::curtainStateChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void DeviceController::lightStateChanged(LightState _t1)
{
...
// SIGNAL 1
void DeviceController::curtainStateChanged(CurtainState _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
